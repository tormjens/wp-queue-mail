...
require_once $queue_folder_path . 'classes/wp-job.php';
require_once $queue_folder_path . 'classes/wp-queue.php';
require_once $queue_folder_path . 'classes/worker/wp-worker.php';
require_once $queue_folder_path . 'classes/worker/wp-http-worker.php';
...
if (defined('WP_CLI') && WP_CLI) {
    require_once $queue_folder_path . 'classes/cli/queue-command.php';
